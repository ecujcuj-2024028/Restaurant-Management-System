...
const UserProfile = () => {
  ...
  // En un sistema real, aquí usarías un store para actualizar el perfil
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-zinc-900/50 border border-white/5 rounded-[2.5rem] p-8 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="relative inline-block mb-4">
                ...
                <button className="absolute bottom-0 right-0 p-2 bg-orange-500 rounded-xl text-white shadow-lg hover:bg-orange-600 transition-all">
                  <Camera size={18} />
                </button>
              </div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-zinc-900/50 border border-white/5 rounded-[2.5rem] p-8 md:p-10">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      disabled={true} // El email suele ser el ID único, no se cambia fácil
