...
const getRestaurantId = (table) => {
    ...
    if (typeof table.restaurant === 'object') return table.restaurant._id || table.restaurant.id || ''
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        {errors.restaurant && (
                            <p className="text-red-400 text-xs mt-1.5 ml-1">{errors.restaurant.message}</p>
                        )}
                        {restaurantsError && (
                            <p className="text-red-400 text-xs mt-1.5 ml-1">Error al cargar restaurantes: {restaurantsError}</p>
                        )}
                    </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                {...register('number', {
                                    ...
                                    min: { value: 1, message: 'El número debe ser al menos 1' },
                                    max: { value: 9999, message: 'El número no puede exceder 9999' },
                                })}
                            ...
                            />
                            {errors.number && (
                                <p className="text-red-400 text-xs mt-1.5 ml-1">{errors.number.message}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                {...register('capacity', {
                                    ...
                                    max: { value: 50, message: 'La capacidad no puede exceder 50' },
                                })}
                                className="w-full bg-zinc-800/50 border border-zinc-700/50 text-white rounded-2xl px-5 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all placeholder:text-zinc-600"
                                placeholder="Ej. 4"
                            />
                            {errors.capacity && (
                                <p className="text-red-400 text-xs mt-1.5 ml-1">{errors.capacity.message}</p>
                            )}
                        </div>
                    </div>
