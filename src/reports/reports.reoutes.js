 ...
 */
router.get('/pdf',   validateJWT, hasRole(ADMIN_RESTAURANTE, ADMIN_SISTEMA), exportPDF);
 ...
 */
router.get('/excel', validateJWT, hasRole(ADMIN_RESTAURANTE, ADMIN_SISTEMA), exportExcel);

/**
 * GET /reports/data?restaurantId=&startDate=&endDate=
 * Devuelve JSON listo para renderizar gráficos en el frontend
 */
router.get('/data',  validateJWT, hasRole(ADMIN_RESTAURANTE, ADMIN_SISTEMA), getChartData);
